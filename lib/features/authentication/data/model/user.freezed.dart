...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, username: $username, firstName: $firstName, lastName: $lastName, gender: $gender, image: $image, email: $email)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, username, firstName, lastName, gender, image, email);
...
abstract class _User implements User {
  factory _User(
      ...
      @HiveField(6) final String? email}) = _$UserImpl;
